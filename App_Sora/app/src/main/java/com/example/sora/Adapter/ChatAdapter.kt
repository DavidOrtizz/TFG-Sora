...
class ChatAdapter (private val mensajes: List<MensajeResponse>, private val context: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return if (viewType == TYPE_ENVIAR) {
            ...
            val view = LayoutInflater.from(parent.context).inflate(R.layout.item_container_recibir_mensaje, parent, false)
